...
**[Emergency_Supplies_Management_System ](https://github.com/Ashesttt/Emergency_Supplies_Management_System)**支持 [Docker Compose 部署](#Docker-Compose- 部署)、[本地部署](./docs/development.md#本地部署)
