<template>
  <div>
    ...
    <el-table :data="tableData" border stripe :header-cell-class-name="headerBg"
      ...
      <el-table-column prop="usageRecordId" label="申请记录id" width="100">
      </el-table-column>
      <el-table-column prop="userId" label="申请人id" width="140">
      </el-table-column>
      ...
      <el-table-column prop="materialId" label="申请物资id" width="140">
      </el-table-column>
      ...
      <el-table-column prop="quantity" label="仓库总量">
      </el-table-column>
      <el-table-column prop="usageQuantity" label="申请数量" width="120">
      </el-table-column>
